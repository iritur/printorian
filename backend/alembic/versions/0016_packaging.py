...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "kind",
            sa.Enum("bag", "box", "wrap", "filler", name="tarakind", native_enum=False, length=40),
            nullable=False,
        ),
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_packaging_tara_tara_length_positive"),
        ),
        sa.CheckConstraint("price >= 0", name=op.f("ck_packaging_tara_tara_price_non_negative")),
        sa.CheckConstraint(
            "reorder_at >= 0", name=op.f("ck_packaging_tara_tara_reorder_non_negative")
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "norm_minutes >= 0",
            name=op.f("ck_packaging_instruction_steps_packaging_step_norm_non_negative"),
        ),
        sa.CheckConstraint(
            "position >= 1",
            name=op.f("ck_packaging_instruction_steps_packaging_step_position_positive"),
        ),
        sa.ForeignKeyConstraint(
            ["instruction_id"],
            ["packaging_instructions.id"],
            name=op.f("fk_packaging_instruction_steps_instruction_id_packaging_instructions"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "elapsed_minutes >= 0", name=op.f("ck_packaging_tasks_packaging_elapsed_non_negative")
        ),
        sa.CheckConstraint(
            "finished_at IS NULL OR started_at IS NULL OR finished_at >= started_at",
            name=op.f("ck_packaging_tasks_packaging_finished_after_started"),
        ),
        sa.CheckConstraint(
            "items >= 0", name=op.f("ck_packaging_tasks_packaging_items_non_negative")
        ),
        sa.CheckConstraint(
            "norm_minutes >= 0", name=op.f("ck_packaging_tasks_packaging_norm_non_negative")
        ),
        sa.CheckConstraint(
            "packaging_cost >= 0", name=op.f("ck_packaging_tasks_packaging_cost_non_negative")
        ),
        sa.CheckConstraint(
            "weight_grams IS NULL OR weight_grams >= 0",
            name=op.f("ck_packaging_tasks_packaging_weight_non_negative"),
        ),
        sa.ForeignKeyConstraint(
            ["operator_id"],
            ["users.id"],
            name=op.f("fk_packaging_tasks_operator_id_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["order_id"],
            ["orders.id"],
            name=op.f("fk_packaging_tasks_order_id_orders"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["tara_id"],
            ["packaging_tara.id"],
            name=op.f("fk_packaging_tasks_tara_id_packaging_tara"),
            ondelete="SET NULL",
        ),
    ...
    op.create_index(
        "ix_packaging_tasks_operator_id", "packaging_tasks", ["operator_id"], unique=False
    )
    op.create_index(
        "ix_packaging_tasks_status_cutoff", "packaging_tasks", ["status", "cutoff_at"], unique=False
    )
    op.create_index("ix_packaging_tasks_tara_id", "packaging_tasks", ["tara_id"], unique=False)
    op.create_table(
        "packaging_task_steps",
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_packaging_task_steps_packaging_task_step_actual_non_negative"),
        ),
        sa.CheckConstraint(
            "norm_minutes >= 0",
            name=op.f("ck_packaging_task_steps_packaging_task_step_norm_non_negative"),
        ),
        sa.CheckConstraint(
            "position >= 1",
            name=op.f("ck_packaging_task_steps_packaging_task_step_position_positive"),
        ),
        sa.ForeignKeyConstraint(
            ["task_id"],
            ["packaging_tasks.id"],
            name=op.f("fk_packaging_task_steps_task_id_packaging_tasks"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "quantity > 0", name=op.f("ck_packaging_task_tara_packaging_use_quantity_positive")
        ),
        sa.ForeignKeyConstraint(
            ["tara_id"],
            ["packaging_tara.id"],
            name=op.f("fk_packaging_task_tara_tara_id_packaging_tara"),
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["task_id"],
            ["packaging_tasks.id"],
            name=op.f("fk_packaging_task_tara_task_id_packaging_tasks"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        "ix_packaging_task_tara_tara_id", "packaging_task_tara", ["tara_id"], unique=False
    )
